...
function EmbedClient({ ownerId }: { ownerId: string }) {
    ...
    return (
        <div className='min-h-screen bg-zinc-500 text-zinc-900'>
            <div className='sticky top-0 z-40 bg-white border-b border-zinc-200'>
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                    ...
                    <button className='px-4 py-2 rounded-lg border border-zinc-300 text-sm hover:bg-zinc-100 transition cursor-pointer' onClick={() => navigate.push("/dashboard")}>
                        Back to Dashboard
                    </button>
                </div>
            </div>
            <div className='flex justify-center px-4 py-14'>
                ...
                >
                    ...
                    <div className='relative bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm font-mono mb-10'>
                        ...
                        <button onClick={copyCode} className='absolute top-3 right-3 bg-white text-zinc-900 text-xs font-medium px-3 py-1.5 rounded-lg hover:bg-zinc-200 transition'>
                            {copied ? "Copied!" : "Copy"}
                        </button>
                    </div>
                    ...
                    <div className='mt-14'>
                        ...
                        <div className='rounded-xl border:border-zinc-300 bg-white shadow-md overflow-hidden'>
                            <div className='flex items-center gap-2 px-4 h-9 bg-zinc-100 border-bottom border-zinc-200'>
